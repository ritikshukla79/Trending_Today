...
export class Navbar extends Component {
    render() {
        return (
            <div>
                <nav className={`navbar navbar-expand-lg navbar-${this.props.mode === 'light' ? 'dark' : 'light'} bg-${this.props.mode === 'light' ? 'dark' : 'light'}`}>
                    ...
                    <div className={`form-check form-switch text-${this.props.mode === 'light' ? 'light' : 'dark'}`}>
